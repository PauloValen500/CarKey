...
<body>
    ...
    <script>
        ...
        function verificarDisponibilidad(idPlaca) {
            let fechaInicio = prompt('Introduce la fecha de inicio de la renta (AAAA-MM-DD):');
            let fechaFin = prompt('Introduce la fecha de fin de la renta (AAAA-MM-DD):');
       ...
       if (fechaInicio && fechaFin) {
        ...
        .then(data => {
            ...
            if (data.disponible) {
                ...
                if (confirm(mensaje)) {
                    window.location.href = `rentaPC.php?idPlaca=${idPlaca}&fechaInicio=${fechaInicio}&fechaFin=${fechaFin}`;
                }
            } else {
